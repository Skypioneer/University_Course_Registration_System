...
/**
 * <p>The class <strong>DuplicateSubjectException</strong> and its subclasses
 * are a form of Throwable that indicates conditions that a reasonable
 * application might want to catch. This cwang_hw4.exception is thrown when
 * attempting to add a duplicate subject.</p>
 *
 * Jason Wang
